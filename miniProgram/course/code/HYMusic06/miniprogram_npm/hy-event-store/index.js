...
__DEFINE__(1640952452320, function(require, module, exports) {
module.exports = {
  HYEventBus: require('./event-bus'),
  HYEventStore: require('./event-store')
}

}, function(modId) {var map = {"./event-bus":1640952452321,"./event-store":1640952452322}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1640952452321, function(require, module, exports) {
class HYEventBus {
  constructor() {
    this.eventBus = {}
  }
...
__DEFINE__(1640952452322, function(require, module, exports) {
...
}, function(modId) { var map = {"./event-bus":1640952452321,"./utils":1640952452323}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1640952452323, function(require, module, exports) {
...
return __REQUIRE__(1640952452320);
})()
