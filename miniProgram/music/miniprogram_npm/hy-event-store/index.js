...
__DEFINE__(1668063126353, function(require, module, exports) {
module.exports = {
  HYEventBus: require('./event-bus'),
  HYEventStore: require('./event-store')
}

}, function(modId) {var map = {"./event-bus":1668063126354,"./event-store":1668063126355}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1668063126354, function(require, module, exports) {
class HYEventBus {
  constructor() {
    this.eventBus = {}
  }
...
__DEFINE__(1668063126355, function(require, module, exports) {
...
}, function(modId) { var map = {"./event-bus":1668063126354,"./utils":1668063126356}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1668063126356, function(require, module, exports) {
...
return __REQUIRE__(1668063126353);
})()
